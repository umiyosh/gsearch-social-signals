...
- Toggle the saved social-signal filter and confirm initial pending results remain visible, settled failures without another positive signal are filtered without retry flicker, and recovered positives are restored.
