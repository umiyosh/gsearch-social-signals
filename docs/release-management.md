...
The current release candidate is `0.2.0`. This release promotes the extension to the Public beta line with the redesigned settings UI, toolbar popup, DuckDuckGo support, and stabilized social-signal requests.
