...
function blueskyBadge(x, y, label = "Bluesky 12 posts") {
  return `
    <g transform="translate(${x} ${y})">
      ${rect(0, 0, 142, 26, { fill: "#eef5ff", stroke: "#b9d7ff", radius: 13 })}
      ${text(12, 18, "↗", { size: 13, weight: 700, fill: colors.bluesky })}
...
function promoSmall() {
  return `
    <svg xmlns="http://www.w3.org/2000/svg" width="440" height="280" viewBox="0 0 440 280">
      ...
      ${blueskyBadge(64, 216, "Bluesky 12 posts")}
    </svg>`
}
...
function promoMarquee() {
  return `
    <svg xmlns="http://www.w3.org/2000/svg" width="1400" height="560" viewBox="0 0 1400 560">
      ...
      ${blueskyBadge(1150, 278, "Bluesky 12 posts")}
